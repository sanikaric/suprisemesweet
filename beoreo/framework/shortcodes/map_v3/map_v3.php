<?php
function beoreo_maps_render($params) {
    ...
    wp_enqueue_script('maps-apiv3', beoreo_URI_PATH_FR . "/shortcodes/map_v3/maps.js",array(),'1.0.0');
    /* Map Style defualt */
    $map_styles = array(
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('maps', 'beoreo_maps_render'); }