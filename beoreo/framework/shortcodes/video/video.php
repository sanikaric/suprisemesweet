<?php
function bearsthemes_video($params, $content = null){
	extract(shortcode_atts(array(
	'height' => 200,
	'width' => '100%'
	), $params));

	wp_enqueue_script('fitvids', beoreo_URI_PATH_FR . "/shortcodes/video/fitvids.js");
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('tb-video', 'bearsthemes_video'); }
