<?php
function bearsthemes_testimonial_carousel_func($atts, $content = null) {
...
if(function_exists('bcore_shortcode')) { bcore_shortcode('testimonial_carousel', 'bearsthemes_testimonial_carousel_func'); }
