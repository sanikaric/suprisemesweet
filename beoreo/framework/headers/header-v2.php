...
<?php 
	...
	if(isset($bearstheme_options['fixed_main_menu_v2']) && $bearstheme_options['fixed_main_menu_v2']) {
	...
	if($disable_stick_menu != 'on') {
		if(isset($bearstheme_options['stick_main_menu_v2']) && $bearstheme_options['stick_main_menu_v2']) {
		...
		<div class="bt-header-menu">
			<div class="row">
				<div class="container">
					...
					<div class="col-md-10 bt-col-menu <?php if (is_active_sidebar("bearstheme-menu-right-sidebar-2")) echo esc_attr('has-menu-right-sidebar'); ?>">
						<?php
							$attr = array(
							...
							wp_nav_menu( $attr );
						?>
						<?php if (is_active_sidebar("bearstheme-menu-right-sidebar-2")){ ?>
							<?php dynamic_sidebar("bearstheme-menu-right-sidebar-2"); ?>
						<?php } ?>
					</div>
				</div>
			</div>
