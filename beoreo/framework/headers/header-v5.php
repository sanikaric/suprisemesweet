...
<?php 
	...
	if($disable_stick_menu != 'on') {
		if(isset($bearstheme_options['stick_main_menu_v5']) && $bearstheme_options['stick_main_menu_v5']) {
				...
				<div class="container">
					...
					<?php if (is_active_sidebar("bearstheme-header-top-widget-2")) { ?>
						<div class="col-md-6 col-sm-6 bt-cc menu-top-p">				
							<?php dynamic_sidebar("bearstheme-header-top-widget-2"); ?>
						</div>
					<?php } ?>
				</div>
			</div>
		...
		<div class="bt-header-top t_bears">
			<div class="row">
				<div class="container">
					...
					<?php if (is_active_sidebar("bearstheme-menu-right-sidebar-5")) { ?>
						<div class="col-md-9 bearsicon_tx">
							<?php 
								dynamic_sidebar("bearstheme-menu-right-sidebar-5");
							?>
						</div>
					<?php } ?>
				</div>
