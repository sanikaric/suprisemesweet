...
class BearsthemesFrameworkMetaboxes {
	...
	function admin_script_loader() {
		...
		if (is_admin() && ($pagenow=='post-new.php' || $pagenow=='post.php')) {
			...
			wp_enqueue_style('tb-metabox', beoreo_URI_PATH_FR.'/meta-boxes/assets/css/metabox.css');
			wp_enqueue_style('colorpicker', beoreo_URI_PATH_FR.'/meta-boxes/assets/css/colorpicker.css');
			wp_enqueue_style('datepicker', beoreo_URI_PATH_FR.'/meta-boxes/assets/css/datepicker.css');
			
			wp_enqueue_script('jcolpick', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/colpick.js');
			wp_enqueue_script('datepicker.min', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/datepicker.min.js');
			wp_enqueue_script('tb-upload', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/upload.js');
			wp_enqueue_script('jquery-easytabs', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/jquery.easytabs.min.js');
			wp_enqueue_script('blog-tabs', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/blog.tab.js');
			wp_enqueue_script('meta-box', beoreo_URI_PATH_FR.'/meta-boxes/assets/js/meta.box.js');
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','beoreo'), 'page');
		$this->add_meta_box('post_video', __('Video Settings','beoreo'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','beoreo'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','beoreo'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','beoreo'), 'post');
		$this->add_meta_box('post_gallery', __('Gallery Settings','beoreo'), 'post');
		$this->add_meta_box('post_portfolio', __('Portfolio Settings','beoreo'), 'portfolio');
		$this->add_meta_box('post_team', __('Team Settings','beoreo'), 'team');
		$this->add_meta_box('post_testimonial', __('Testimonial Settings','beoreo'), 'testimonial');
		$this->add_meta_box('post_package', __('Package Settings','beoreo'), 'package');
	}
